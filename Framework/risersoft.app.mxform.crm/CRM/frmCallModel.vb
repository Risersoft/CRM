...
Public Class frmCallModel
    ...
    Private Sub InitForm()
        ...
        sql = myFuncsBase.CodeWordSQL("Call", "Direction", "")
        Me.AddLookupField("Direction", myUtils.AddTable(Me.dsCombo, myContext.Provider.objSQLHelper.ExecuteDataset(CommandType.Text, sql), "Direction").TableName)
        ...
        vlist1.Add("Not answered", "Not answered")
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        sql = "Select * from Call Where CallID = " & prepIDX
    ...
    Public Overrides Function VSave() As Boolean
        ...
        If Me.Validate Then
            ...
            If frmMode = EnumfrmMode.acEditM Then
                Dim sql As String = "select CallID from Call left Join userset on Call.AssignUserSetID = Userset.UserSetID where dbo.fncCRMVisible('" & myContext.Police.UniqueUserID & "', AssignUserID, Call.CreatedByID, '00000000-0000-0000-0000-000000000000', AssignTeamID, UserSet.UserSetList)= 1"
            ...
            If Me.CanSave Then
                Dim CallDescrip As String = myUtils.cStrTN(myRow("Name"))
                Try
                    ...
                    myContext.Provider.dbConn.BeginTransaction(myContext, Me.Name, Me.frmMode.ToString, "CallID", frmIDX, UserIDCSV)
                    myContext.Provider.objSQLHelper.SaveResults(myRow.Row.Table, Me.sqlForm)

                    ' myView.MainGrid.SaveChanges(, "CallID=" & frmIDX)
