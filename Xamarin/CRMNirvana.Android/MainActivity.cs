...
using GSTNirvana.Droid;
using GSTNirvana;

namespace CRMNirvana.Droid
{

    [Activity(Label = "CRMNirvana", Icon = "@drawable/icon", Theme = "@style/MyTheme.Splash", MainLauncher = true,NoHistory =true)]
    ...
    [Activity(Label = "CRMNirvana", Theme = "@style/MyTheme",ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation,ScreenOrientation =ScreenOrientation.Portrait)]
