...
Public Class frmCall
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmCallModel = Me.InitData("frmCallModel", oView, prepMode, prepIDX, strXML)
        If Me.BindModel(objModel, oView) Then
            myWinSQL.AssignCmb(Me.dsCombo, "User", "", Me.cmb_AssignUserID)
            myWinSQL.AssignCmb(Me.dsCombo, "Team", "", Me.cmb_AssignTeamID)
            myWinSQL.AssignCmb(Me.dsCombo, "Direction", "", Me.cmb_Direction)
    ...
    Private Sub btnDeleteCall_Click(sender As Object, e As EventArgs) Handles btnDeleteCall.Click
        If MsgBox("Are you sure you want to delete this Call", MsgBoxStyle.YesNo, myWinApp.Vars("appname")) = MsgBoxResult.Yes Then
            myRow("isDeleted") = 1
