...
Public Class frmLead
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmLeadModel = Me.InitData("frmLeadModel", oView, prepMode, prepIDX, strXML)
        If Me.BindModel(objModel, oView) Then
            ...
            myWinSQL.AssignCmb(Me.dsCombo, "Salutation", "", Me.cmb_Salutation)
            myWinSQL.AssignCmb(Me.dsCombo, "Status", "", Me.cmb_Status)
            Me.cmb_SMSOptIn.ValueList = Me.Model.ValueLists("SMSOptIn").ComboList
    ...
    Private Sub btnDeleteLead_Click(sender As Object, e As EventArgs) Handles btnDeleteLead.Click
        If MsgBox("Are you sure you want to delete this Lead", MsgBoxStyle.YesNo, myWinApp.Vars("appname")) = MsgBoxResult.Yes Then
            myRow("isDeleted") = 1
