...
Public Class frmCallMarketing
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmCallMarketingModel = Me.InitData("frmCallMarketingModel", oView, prepMode, prepIDX, strXML)
        If Me.BindModel(objModel, oView) Then
            myWinSQL.AssignCmb(Me.dsCombo, "User", "", Me.cmb_AssignUserID)
            myWinSQL.AssignCmb(Me.dsCombo, "Team", "", Me.cmb_AssignTeamID)
            myWinSQL.AssignCmb(Me.dsCombo, "distri", "", Me.cmb_Distribution)
        ...
        If Me.frmMode = EnumfrmMode.acEditM Then
            ...
            If Not IsNothing(rr) Then
                For Each r1 As DataRow In rr
                    ...
                    r2("PIDField") = "CallMarketingID"
                    r2("PIDValue") = myRow("CallMarketingID")
                Next
            End If
        Else
    ...
    Private Sub btnDeleteCallMarket_Click(sender As Object, e As EventArgs) Handles btnDeleteCallMarket.Click
        If MsgBox("Are you sure you want to delete this Call Marketing", MsgBoxStyle.YesNo, myWinApp.Vars("appname")) = MsgBoxResult.Yes Then
            myRow("isDeleted") = 1
