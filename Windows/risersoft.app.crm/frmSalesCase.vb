...
Public Class frmSalesCase
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmSalesCaseModel = Me.InitData("frmSalesCaseModel", oView, prepMode, prepIDX, strXML)
    ...
    Private Sub btnDeleteCase_Click(sender As Object, e As EventArgs) Handles btnDeleteCase.Click
        If MsgBox("Are you sure you want to delete this Select Case", MsgBoxStyle.YesNo, myWinApp.Vars("appname")) = MsgBoxResult.Yes Then
            myRow("isDeleted") = 1
