...
@Code
    ...
    If (Not Me.User Is Nothing) AndAlso (Not Me.User.Identity Is Nothing) Then
        _user = AuthUtils.GetRSUser(Me.User.Identity)
            ...
            <div Class="row">
                <div Class="col-md-3" style="margin-top: 0px;">
                    <div class="logo-header">
                        <div class="pull-left mobo-widthtab"><a href="/app" class="link-underline"><h5 class="uni-logo" style="margin-top: 0px;"><img src="~/Content/images/Nirvana.png" class="ninja-logo" />CRMNirvana</h5></a></div>
